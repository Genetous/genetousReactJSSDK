...
exports.verifyToken = exports.postwithAddToken = exports.postWithSavedToken = exports.postWithNoToken = exports.organization = exports.login = exports.killToken = exports.getwithAddToken = exports.getWithSavedToken = exports.getWithNoToken = exports.getGuestTokenReturnToken = exports.getGuestToken = exports.fileUpload = exports.domain = exports.Methods = void 0;
  ...
  return new Promise(async function (resolve, reject) {
    try {
      ...
      if (localStorage.getItem('token') != null && localStorage.getItem('token') != "") {
        tk = "Bearer ".concat(localStorage.getItem('token'));
      } else {
        reject(401);
        return;
      }
      ...
      const responseCollection = await fetch(Methods.VerifyToken, {
        method: 'GET',
        headers: hd
      });
...
var killToken = function killToken() {
  return new Promise(async function (resolve, reject) {
    try {
      var hd = new Headers();
      var tk = "";
      ...
      hd.append('Authorization', tk);
      const responseCollection = await fetch(Methods.KillToken, {
        method: 'POST',
        headers: hd
      });
      resolve(responseCollection.json());
  ...
  return new Promise(async function (resolve, reject) {
    try {
      ...
      if (operationStep === 0) {
        ...
        hd.append('Authorization', tk);
        hd.append("Content-Type", "application/json");
        const responseCollection = await fetch(Methods.GetCollections, {
          method: 'POST',
          headers: hd,
...
var getGuestTokenReturnToken = function getGuestTokenReturnToken() {
  return new Promise(async function (resolve, reject) {
    try {
      Object.keys(organization).forEach(function (key) {
        if (key === "clientId") {
...
exports.getGuestTokenReturnToken = getGuestTokenReturnToken;
var postWithSavedToken = function postWithSavedToken(model, method) {
  return new Promise(async function (resolve, reject) {
    try {
      var hd = new Headers();
      var tk = "";
      ...
      const responseCollection = await fetch(method, {
        method: 'POST',
        headers: hd,
...
exports.postWithSavedToken = postWithSavedToken;
var postWithNoToken = function postWithNoToken(model, method) {
  return new Promise(async function (resolve, reject) {
    try {
      var hd = new Headers();
      hd.append("Content-Type", "application/json");
...
exports.postWithNoToken = postWithNoToken;
var postwithAddToken = function postwithAddToken(model, method, tk) {
  return new Promise(async function (resolve, reject) {
    try {
      var hd = new Headers();
      hd.append('Authorization', tk);
...
exports.postwithAddToken = postwithAddToken;
var fileUpload = function fileUpload(file, method, config, random) {
  return new Promise(async function (resolve, reject) {
    try {
      var rdata = {
        status: -1,
...
var getWithSavedToken = function getWithSavedToken(method) {
  return new Promise(async function (resolve, reject) {
    try {
      var hd = new Headers();
      var tk = "";
...
exports.getWithSavedToken = getWithSavedToken;
var getWithNoToken = function getWithNoToken(method) {
  return new Promise(async function (resolve, reject) {
    try {
      var hd = new Headers();
      var rdata = {
...
exports.getWithNoToken = getWithNoToken;
var getwithAddToken = function getwithAddToken(method, tk) {
  return new Promise(async function (resolve, reject) {
    try {
      var hd = new Headers();
      hd.append('Authorization', tk);
...
exports.getwithAddToken = getwithAddToken;